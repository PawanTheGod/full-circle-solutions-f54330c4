...
const navLinks = [
  ...
  { label: "Testimonials", path: "/testimonials" }, // New link added here
          ...
          <SheetContent side="right" className="w-full sm:w-[400px] border-l-0 p-0 overflow-hidden">
            <div className="flex flex-col h-full bg-white p-8 md:p-12">
              <SheetTitle className="flex items-center gap-2 font-bold text-2xl mb-16">
                <div className="w-10 h-10 bg-neutral-900 rounded-xl flex items-center justify-center text-white text-xs">360</div>
                Marketing<span className="text-primary">.</span>
              </SheetTitle>
              ...
              <div className="mt-auto pt-12">
                <p className="text-neutral-400 text-xs uppercase tracking-[0.3em] font-bold mb-6">Let's build something</p>
                <Button
                  asChild
