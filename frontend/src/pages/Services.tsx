    ...
    services: [
      {
        ...
        desc: "B2B lead generation through strategic executive positioning.",
        price: "₹25,000/mo",
      },
      {
        icon: Search,
        title: "Search Ecosystems",
        desc: "Omnichannel SEO to ensure you own your market's search intent.",
        price: "From ₹15,000/mo",
      },
      {
        icon: Megaphone,
        title: "Performance Media",
        desc: "Data-driven PPC management across Google and Meta networks.",
    ...
    services: [
      {
        ...
        desc: "High-end product and lifestyle shoots for premium brands.",
        price: "₹10,000 - ₹25,000",
      },
      {
        icon: Film,
        title: "Cinematic Reels",
        desc: "Short-form vertical storytelling optimized for rapid virality.",
        price: "₹5,000 - ₹12,000",
      },
      {
        icon: Scissors,
        title: "Post-Production",
        desc: "Professional grading, sound design, and motion graphics.",
        price: "From ₹8,000",
      },
    ],
  },
    ...
    services: [
      {
        ...
        desc: "Custom web development focused on conversion and speed.",
        price: "₹1.5 Lakh+",
      },
      {
        icon: Layout,
        title: "Conversion Nodes",
        desc: "High-impact landing pages for specific marketing funnels.",
        price: "From ₹25,000",
      },
    ],
  },
                    ...
                    <ScrollAnimation key={s.title} delay={i * 100}>
                      <div className="group p-8 rounded-[2rem] bg-neutral-50 border border-transparent hover:border-neutral-200 hover:bg-white hover:shadow-2xl transition-all duration-500 flex flex-col h-full">
                        ...
                        <div className="pt-6 border-t border-neutral-100 flex items-center justify-between">
                          ...
                          <Link
                            to="/contact"
                            className="p-2 rounded-full bg-neutral-100 group-hover:bg-primary group-hover:text-white transition-all"
                          >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-xl">
              ...
              <p className="text-neutral-400 font-light leading-relaxed">
                ...
                business card design, brochure architecture, and newspaper ad
                placements for brands that require a physical footprint.
              </p>
            </div>
            <Button
              asChild
              className="h-16 px-10 rounded-2xl bg-white text-black hover:bg-primary hover:text-white transition-all shadow-xl font-bold"
            >
          ...
          <ScrollAnimation>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Button
                asChild
                variant="ghost"
                className="h-20 px-12 rounded-full text-lg border border-neutral-100"
              >
