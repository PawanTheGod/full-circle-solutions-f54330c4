...
const faqs = [
  {
    ...
    a: "Most strategic projects commence within 2–3 business days following our initial alignment call.",
  },
  {
    q: "Do you work with startups?",
    a: "Exclusively. We offer bespoke growth packages tailored for high-potential emerging enterprises.",
  },
  {
    q: "What is the typical timeline?",
    a: "High-impact campaigns typically transition from concept to market launch within 7–14 days.",
  },
  {
    q: "Can I review your portfolio?",
    a: "Certainly. Our curated collection of global success stories is available on the Portfolio page.",
  },
];
...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (!form.email || !/\S+@\S+\.\S+/.test(form.email))
      e.email = "Valid professional email required";
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#1a1a1a] selection:bg-black selection:text-white">
      <Helmet>
        <title>Contact | 360 Marketing Agency</title>
      </Helmet>
      ...
      <section className="relative pt-24 pb-12 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          <span className="text-[10px] uppercase tracking-[0.5em] text-primary font-bold mb-6 block">
            Direct Channel
          </span>
          ...
          <p className="text-lg text-neutral-500 max-w-2xl mx-auto font-light leading-relaxed">
            Elevate your market presence with 360° strategy. Our elite team is
            ready to transform your vision into global dominance.
          </p>
        </div>
      </section>

      {/* MAIN INTERACTION SECTION */}
      <section className="container mx-auto px-6 grid lg:grid-cols-12 gap-16 pb-20">
        {/* PREMIUM FORM CARD */}
            ...
            <form onSubmit={submit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] uppercase tracking-widest font-bold text-neutral-400 ml-1">
                    Full Name *
                  </label>
                  <Input
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    className="h-14 border-none ring-1 ring-neutral-200 bg-neutral-50/50 rounded-xl"
              ...
              <Button
                className="w-full h-16 rounded-xl bg-neutral-900 text-white hover:bg-black transition-all text-lg font-semibold group"
                disabled={loading}
              >
                {loading ? (
        ...
        <div className="lg:col-span-5 flex flex-col justify-between py-6">
          <div className="space-y-14">
            <div>
              <h3 className="text-xs uppercase tracking-[0.4em] font-bold text-primary mb-10">
                Concierge Services
              </h3>
            ...
            <div className="pt-10 border-t border-neutral-200/60">
              <h3 className="text-[10px] uppercase tracking-[0.3em] font-bold text-neutral-400 mb-6">
                Connect Digitally
              </h3>
          ...
          <div className="relative grid lg:grid-cols-3 gap-0 border border-neutral-100 rounded-[3rem] overflow-hidden bg-white shadow-[0_40px_100px_rgba(0,0,0,0.06)]">
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center bg-neutral-900 text-white">
              ...
              <p className="text-neutral-400 font-light leading-relaxed mb-10 text-lg">
                Our creative lab is where strategy meets art. Private
                consultations available by appointment for select clients.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-5">
                  ...
                  <p className="text-sm font-medium tracking-wide">
                    Level 5, Sky Tower, Pune, MH 411001
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/3">
              ...
              <h2 className="text-5xl font-bold tracking-tighter mb-6 leading-[0.9]">
                Common <br />
                Questions.
              </h2>
              <p className="text-neutral-500 font-light text-lg">
                Detailed insights into our operational philosophy and client
                engagement process.
              </p>
            </div>
            <div className="lg:w-2/3 grid gap-6">
              {faqs.map((f, i) => (
                <details
                  key={i}
                  className="group border-b border-neutral-100 pb-6"
                >
                  <summary className="list-none cursor-pointer flex justify-between items-center py-6 text-xl font-semibold hover:text-primary transition-colors">
                    {f.q}
                    <span className="text-3xl font-extralight group-open:rotate-45 transition-transform duration-300">
                      +
                    </span>
                  </summary>
      ...
      {success && (
        <div className="fixed inset-0 bg-neutral-950/95 backdrop-blur-xl flex items-center justify-center z-[100] p-6">
          <div className="bg-white p-16 rounded-[3rem] text-center max-w-xl shadow-2xl animate-in fade-in zoom-in duration-500">
            ...
            <h3 className="text-4xl font-bold mb-4 tracking-tight text-neutral-900">
              Inquiry Authenticated
            </h3>
            <p className="text-neutral-500 mb-10 text-lg font-light">
              Our strategy team has been alerted. We will reach out to schedule
              your private alignment session shortly.
            </p>
            <Button
              onClick={() => setSuccess(false)}
              className="px-12 h-16 rounded-2xl bg-black text-white hover:scale-105 transition-transform"
            >
              Return to Portal
            </Button>
          </div>
  ...
  return (
    <div className="flex items-start gap-6 group">
      <div className="w-14 h-14 rounded-2xl bg-white border border-neutral-100 flex items-center justify-center shadow-sm group-hover:border-primary/40 group-hover:bg-primary/5 transition-all duration-500">
        <Icon
          size={22}
          className="text-neutral-400 group-hover:text-primary transition-colors duration-500"
          strokeWidth={1.2}
        />
      </div>
      <div className="pt-1">
        ...
        <p className="text-xl font-medium text-neutral-800 tracking-tight">
          {text}
        </p>
      </div>
    </div>
